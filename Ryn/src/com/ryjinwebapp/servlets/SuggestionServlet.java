...
public class SuggestionServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("GET".equalsIgnoreCase(request.getMethod()) || request.getParameter("suggestion") == null) {
            System.out.println("Rendering form - GET request or no suggestion parameter");
            renderForm(out, contextPath);
        } else {
            String suggestion = request.getParameter("suggestion");
            System.out.println("Received suggestion: " + suggestion);

            if (suggestion.trim().isEmpty()) {
                System.out.println("Empty suggestion received");
                response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                renderError(out, contextPath, "Error: Empty suggestion");
            } else {
                System.out.println("Suggestion processed successfully");
                response.setStatus(HttpServletResponse.SC_OK);
                renderSuccess(out, contextPath, suggestion);
            }
        }
    }

    private void renderForm(PrintWriter out, String contextPath) {
        ...
        out.println("    </div>");
        out.println("    <form action='" + contextPath + "/suggestion' method='post' id='suggestionForm'>");
        ...
        out.println("</div>");
        out.println("<script>");
        out.println("document.getElementById('suggestionForm').addEventListener('submit', function(e) {");
        out.println("    console.log('Form submitted');");
        out.println("});");
        out.println("</script>");
        out.println("</body>");
        out.println("</html>");
    ...
    private void renderSuccess(PrintWriter out, String contextPath, String suggestion) {
        out.println("<!DOCTYPE html>");
    ...
    private void renderError(PrintWriter out, String contextPath, String errorMessage) {
        out.println("<!DOCTYPE html>");
